...
export { processConversationMemory, extractFactsFromMessage, storeConversationFacts } from "./conversation-extractor";
...
export type { FactCategory, ExtractedFact } from "./conversation-extractor";
